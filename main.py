...
import DataSet
from utils import test, Flatten, plot_roc_curve, evaluate, plot_boxplots
from Vit import ViT
        ...
        if epoch % 1 == 0:
            ...
            if val_acc > best_acc:
                ...
                if modelflag == 0:
                    ...
                    torch.save(model.state_dict(), 'best2.mdl')
